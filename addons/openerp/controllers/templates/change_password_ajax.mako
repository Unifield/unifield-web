...
<%def name="header()">
    ...
    <script type="text/javascript">
        ...
        var do_change_password = function(form) {
            ...
            var new_password = openobject.dom.get('new_password').value;
            var confirm_password = openobject.dom.get('confirm_password').value;
            ...
            var req = openobject.http.getJSON('/openerp/change_password', {
...
<%def name="content()">
    <div class="view">
        ...
        <form onsubmit="return do_change_password()" action="/openerp"
        method="post" name="changepasswordform">
